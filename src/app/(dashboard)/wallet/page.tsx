...
export default function WalletPage() {
    ...
    const handleFundWallet = (amount: string, paymentMethod: string, cardData?: {
        cardNumber: string;
        cardName: string;
        cardExpiry: string;
        cardCvv: string;
    ...
    return (
        <div>
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <Switch
                                    ...
                                    onCheckedChange={setIsBalanceVisible}
                                />
                            </div>
                        </div>
                    </div>
            ...
            {/* Recent Transactions */}
            <div className="mb-6">
                <h2 className="text-lg font-semibold text-secondary-000 leading-6">
                    Recent Transactions
                </h2>
            </div>
                            ...
                            <div className="flex-1 min-w-0">
                                <div className="flex items-start justify-between gap-3 mb-1">
                                    ...
                                    <div className="flex flex-col items-end gap-1">
                                        <p
                                            className={`text-base font-semibold whitespace-nowrap ${isCredit ? 'text-green-600' : 'text-red-600'
                                                }`}
                                        >
