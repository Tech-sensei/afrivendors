                        ...
                        >
                            <div className="bg-white rounded-3xl shadow-[0_20px_60px_rgba(35,19,5,0.2)] p-8 relative">
                                ...
                                <div className="text-center mb-6">
                                    <div
                                        className={`w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-4 transition-all duration-300 ease-out ${isSuccess ? 'bg-green-100' : 'bg-secondary-700'
                                            }`}
                                    >
                                        {isSuccess ? (
                                            <CheckCircle2 className="h-8 w-8 text-green-600" />
                                        ) : (
                                            <Smartphone className="h-8 w-8 text-primary-100" />
                                        )}
                                    </div>
                                ...
                                {!isSuccess && (
                                    <>
                                        <div className="flex gap-2 justify-center mb-6">
                                            {otp.map((digit, index) => (
                                                <input
                                                    ...
                                                    className={`w-12 h-14 rounded-xl border-2 text-center font-unbounded text-2xl font-semibold text-secondary-000 outline-none transition-all duration-200 ease-out ${digit
                                                        ? 'border-primary-100'
                                                        : 'border-accent-20'
                                                        } ${isVerifying
                                        ...
                                        <button
                                            ...
                                            className={`w-full h-12 rounded-xl border-none font-semibold text-base cursor-pointer transition-all duration-200 ease-out mb-4 ${otp.every(digit => digit !== '') && !isVerifying
                                        ...
                                        <div className="text-center">
                                            ...
                                            <button
                                                ...
                                                disabled={!canResend}
                                                className={`bg-none border-none font-semibold text-sm transition-all duration-200 ease-out ${canResend
