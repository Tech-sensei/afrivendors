                        ...
                        <div className="px-6 py-5 border-b border-accent-20">
                            <div className="flex items-center justify-between mb-3">
                                <div className="flex items-center gap-3">
                                    <h3 className="text-secondary-000 font-semibold text-xl leading-[1.4]">
                                        Notifications
                                    </h3>
                                    {unreadCount > 0 && (
                            ...
                            {notifications.length === 0 ? (
                                <div className="flex flex-col items-center gap-3 py-12 px-6">
                                    ...
                                    <div className="text-center">
                                        <p className="text-secondary-000 font-semibold text-base mb-1">
                                            No notifications
                                        </p>
                                                    ...
                                                    <div className="flex gap-3">
                                                        ...
                                                        <div className="flex-1 min-w-0">
                                                            <div className="flex items-start justify-between gap-2 mb-1">
                                                                <p className="text-secondary-000 font-semibold text-sm leading-[1.4]">
                                                                    {notification.title}
                                                                </p>
                                                            ...
                                                            <p className="text-accent-80 text-sm leading-normal">
