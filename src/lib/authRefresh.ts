...
import type { ClientAuthRefreshResponse } from "@/types/auth";
 ...
 */
export async function performTokenRefresh(): Promise<ClientAuthRefreshResponse | null> {
  ...
  try {
    ...
    const body = unwrapData<ClientAuthRefreshResponse>(res.data);
